      ...
      <div className="row">
        ...
        <div className="col-xl-3 col-md-3 col-sm-5">
          ...
          <div className="sidebar">
            ...
            <div className='col-md-8 formatter'>
        ...
        <div className="col-xl-9 col-md-9 col-sm-7">
          ...
          <nav className="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div className="col-md-10" style={{ textAlign: 'end' }}>
          ...
          <h6 style={{textAlign:"left", marginBottom:"12px", marginTop:"4px", marginLeft:"14px"}}>Upload Inventory file</h6>
